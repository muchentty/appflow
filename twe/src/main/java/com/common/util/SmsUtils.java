...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIOwExf6HTpycy";
    static final String accessKeySecret = "YdeYYSlQ9KrgGuLL4DZLnsCCCYTP6Z";
    ...
    public static SendSmsResponse sendSms(String phoneNumber, String content) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("深圳市医疗器械项目");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_162522269");
        ...
        try {
            if (!CollectionUtils.isEmpty(list)) {
                for (String phoneNumber : list) {
                    sendSms(phoneNumber, codeJson);
                }
            }
        } catch (Exception ex) {
            logger.error("======= SmsUtils sendMsg error=======", ex);
        }
    }
